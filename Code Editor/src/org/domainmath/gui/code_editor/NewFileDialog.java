...
public class NewFileDialog extends javax.swing.JDialog {
    ...
    private final CodeEditorFrame frame;
     ...
     */
    public NewFileDialog(CodeEditorFrame frame, boolean modal,String dynareOptions, String dynarePath) {
        super(frame, modal);
        initComponents();
        this.frame =frame;
       this.NewDocListener();
    ...
    public void setFile(File file, int index) {
        frame.setUpArea();
                fname= file.getName();
                if(fname.endsWith(".m")) {
                         frame.area.setSyntaxEditingStyle(SyntaxConstants.SYNTAX_STYLE_PYTHON);
                         ...
                         frame.area.setSyntaxEditingStyle(SyntaxConstants.SYNTAX_STYLE_PERL);
