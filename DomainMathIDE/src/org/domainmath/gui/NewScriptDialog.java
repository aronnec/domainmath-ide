...
public class NewScriptDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form NewScriptDialog
     */
    public NewScriptDialog(MainFrame frame, boolean modal,String dynareOptions, String dynarePath) {
        super(frame, modal);
        initComponents();
        this.frame =frame;
       this.NewDocListener();
