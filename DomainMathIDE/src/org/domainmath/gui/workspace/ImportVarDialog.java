...
public class ImportVarDialog extends javax.swing.JDialog {
    private String an;
    private String tn;
    private String ra;
    ...
    public ImportVarDialog(java.awt.Frame parent, boolean modal,String txt) {
        super(parent, modal);
        an ="An";
        tn ="Tn";
        ra ="Ra";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        an = this.jTextField1.getText();
        tn = this.jTextField2.getText();
