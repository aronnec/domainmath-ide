...
public class StructBrowserFrame extends javax.swing.JFrame {
    ...
    public StructBrowserFrame(String path) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StructBrowserFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StructBrowserFrame("").setVisible(true);
            }
        });
    }
