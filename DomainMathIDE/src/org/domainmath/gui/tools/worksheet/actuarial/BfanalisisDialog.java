...
public class BfanalisisDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form BfanalisisDialog
     */
    ...
    private void hiddenWork(String cmd){
         MainFrame.octavePanel.eval("pkg load actuarial;");
             ...
             MainFrame.octavePanel.evaluate("_obResult = javaObject('ResultsFrame',disp('QUOTAS'));");
             MainFrame.octavePanel.evaluate("_obResult.appendText(disp(quotas))");
             
             MainFrame.octavePanel.evaluate("_obResult.appendText(disp('OUTCOME'))");
             MainFrame.octavePanel.evaluate("_obResult.appendText(disp(outcome))");
    }
}
