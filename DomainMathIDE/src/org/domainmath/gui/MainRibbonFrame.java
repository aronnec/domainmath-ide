...
public class MainRibbonFrame extends JRibbonFrame {
    ...
    private void createTaskBar(){
        ...
        cutTaskBarButton = new JCommandButton(null,getResizableIcoFromResource24("resources/icons/size24/edit-cut.png"));
        this.getRibbon().addTaskbarComponent(this.cutTaskBarButton);
        copyTaskBarButton = new JCommandButton(null,getResizableIcoFromResource24("resources/icons/size24/edit-copy.png"));
        this.getRibbon().addTaskbarComponent(this.copyTaskBarButton);
        pasteTaskBarButton = new JCommandButton(null,getResizableIcoFromResource24("resources/icons/size24/edit-paste.png"));
        this.getRibbon().addTaskbarComponent(this.pasteTaskBarButton);
