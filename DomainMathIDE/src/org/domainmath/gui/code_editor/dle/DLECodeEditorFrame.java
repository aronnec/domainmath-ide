 ...
 */
package org.domainmath.gui.code_editor.dle;
...
public class DLECodeEditorFrame extends javax.swing.JFrame {
   ...
   private  List fileNameList =Collections.synchronizedList(new ArrayList());
    ...
    private void initComponents() {
        ...
        jMenu1.setMnemonic(java.util.ResourceBundle.getBundle("org/domainmath/gui/code_editor/dle/resources/DLECodeEditor_en").getString("buildMenu.mnemonic").charAt(0));
        ...
        octFileItem.setMnemonic(java.util.ResourceBundle.getBundle("org/domainmath/gui/code_editor/dle/resources/DLECodeEditor_en").getString("octFileItem.mnemonic").charAt(0));
        ...
        mexFileItem.setMnemonic(java.util.ResourceBundle.getBundle("org/domainmath/gui/code_editor/dle/resources/DLECodeEditor_en").getString("mexFileItem.mnemonic").charAt(0));
        ...
        exeItem.setMnemonic(java.util.ResourceBundle.getBundle("org/domainmath/gui/code_editor/dle/resources/DLECodeEditor_en").getString("exeItem.mnemonic").charAt(0));
    ...
    public void oct() {
        String s = fileTab.getToolTipTextAt(fileTab.getSelectedIndex());
           ...
           MainFrame.octavePanel.append("Building "+f.getAbsolutePath()+" ..."+"\n");
